...
[![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2FLanceLRQ%2Fdeer-executor.svg?type=shield)](https://app.fossa.io/projects/git%2Bgithub.com%2FLanceLRQ%2Fdeer-executor?ref=badge_shield)
 ...
 - Most code languages supported. You can add your own Provider. 
 - This executor is standalone executable. Try build and run it with shell.
 - Linux and MacOS Supported, or you can help me support Windows ;-)
...
```
**Environment:** Go 1.11+ (with Go Modules on)
