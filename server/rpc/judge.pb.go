...
type JudgementRequest struct {
	...
	Problem           string        `protobuf:"bytes,2,opt,name=problem,proto3" json:"problem,omitempty"`                                                       // 题目名称
	EnableLog         bool          `protobuf:"varint,3,opt,name=enable_log,json=enableLog,proto3" json:"enable_log,omitempty"`                                 // 启用评测日志
	LogLevel          JudgeLogLevel `protobuf:"varint,4,opt,name=log_level,json=logLevel,proto3,enum=rpc.JudgeLogLevel" json:"log_level,omitempty"`             // 评测日志等级
	...
	SignResult        bool          `protobuf:"varint,13,opt,name=sign_result,json=signResult,proto3" json:"sign_result,omitempty"`                             // 对评测记录进行GPG签名（本地模式可以用）
	GpgKey            string        `protobuf:"bytes,14,opt,name=gpg_key,json=gpgKey,proto3" json:"gpg_key,omitempty"`                                          // Base64编码后的gpg私钥（本地模式可以用）
	GpgPassphrase     string        `protobuf:"bytes,15,opt,name=gpg_passphrase,json=gpgPassphrase,proto3" json:"gpg_passphrase,omitempty"`                     // gpg私钥（本地模式可以用）
}
...
func (x *JudgementRequest) GetProblem() string {
	if x != nil {
		return x.Problem
	}
	return ""
...
type JudgementResponse struct {
	...
	JudgeResultData string    `protobuf:"bytes,2,opt,name=JudgeResultData,proto3" json:"JudgeResultData,omitempty"`         // 评测结果数据(JSON)
	ResultPackage   string    `protobuf:"bytes,3,opt,name=ResultPackage,proto3" json:"ResultPackage,omitempty"`             // 评测运行数据打包文件(URI)
}
...
func (x *JudgementResponse) GetJudgeResultData() string {
	if x != nil {
		return x.JudgeResultData
	}
	return ""
}

func (x *JudgementResponse) GetResultPackage() string {
	if x != nil {
		return x.ResultPackage
	}
	return ""
}
...
var file_protos_judge_proto_rawDesc = []byte{
	...
	,
	...
	0x2a, 0x44, 0x0a, 0x0d, 0x4a, 0x75, 0x64, 0x67, 0x65, 0x4c, 0x6f, 0x67, 0x4c, 0x65, 0x76, 0x65,
	0x6c, 0x12, 0x09, 0x0a, 0x05, 0x55, 0x4e, 0x53, 0x45, 0x54, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05,
	...
	,
	...
	0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x0e, 0x53, 0x74, 0x61,
	0x72, 0x74, 0x4a, 0x75, 0x64, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x15, 0x2e, 0x72, 0x70,
	0x63, 0x2e, 0x4a, 0x75, 0x64, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x16, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x4a, 0x75, 0x64, 0x67, 0x65, 0x6d, 0x65,
	0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x72,
