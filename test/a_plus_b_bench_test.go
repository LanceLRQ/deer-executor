...
func BenchmarkAPlusBProblem(b *testing.B) {
	...
	testCaseMap := []CodeCases{
		{Path: "./data/codes/APlusB/ac.c", Expect: constants.JudgeFlagAC},
		{Path: "./data/codes/APlusB/pe.c", Expect: constants.JudgeFlagPE},
		{Path: "./data/codes/APlusB/pe2.c", Expect: constants.JudgeFlagPE},
		{Path: "./data/codes/APlusB/pe3.c", Expect: constants.JudgeFlagPE},
		{Path: "./data/codes/APlusB/wa.c", Expect: constants.JudgeFlagWA},
		{Path: "./data/codes/APlusB/wa2.c", Expect: constants.JudgeFlagWA},
		{Path: mle, Expect: constants.JudgeFlagMLE},
		{Path: "./data/codes/APlusB/tle.c", Expect: constants.JudgeFlagTLE},
		{Path: "./data/codes/APlusB/ole.c", Expect: constants.JudgeFlagOLE},
		{Path: "./data/codes/APlusB/re.c", Expect: constants.JudgeFlagRE},
		{Path: "./data/codes/APlusB/re2.c", Expect: constants.JudgeFlagRE},
		{Path: "./data/codes/APlusB/ce.c", Expect: constants.JudgeFlagCE},
	}
